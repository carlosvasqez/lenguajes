...
public class GeneradorGrafico {
	...
	String nombreArchivo = String.valueOf(token.hashCode());

	//
	//
	//CREA CARPETA
	Path carpetaPath = Paths.get(PATH_CARPETA_ARCHIVOS);
	try {
	...
	String pathCompletoArchivo = PATH_CARPETA_ARCHIVOS + nombreArchivo + ".dot";
	...
	String pathCompletoImagen = PATH_CARPETA_ARCHIVOS + nombreArchivo + ".png";
	try {
